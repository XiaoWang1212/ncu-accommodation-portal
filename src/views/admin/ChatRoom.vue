    ...
    <div class="chatroom-flame">
        <div class="chatroom-title">
            <div class="chat-person">
                <img class="landlord-image" src="https://randomuser.me/api/portraits/men/42.jpg"></img>
        ...
        <div class="chatroom">
            <div class="msg-tenant">
                ...
                <img class="msg-tenant-image"  src="https://randomuser.me/api/portraits/women/65.jpg"></img>
            </div>
            <div class="msg-landlord">
                <img class="msg-landlord-image" src="https://randomuser.me/api/portraits/men/42.jpg"></img>
                <div class="message-landlord">已完成冷媒添加及系統清潔，冷氣已恢復正常運作。</div>
                <div class="time">5:15</div>
            </div>
            <div class="input-flame">
                <input placeholder="請輸入文字..."></input>
